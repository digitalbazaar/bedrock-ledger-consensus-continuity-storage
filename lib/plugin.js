    ...
    expandIndexes: async ({createIndexes, collections}) => {
      await createIndexes([{
        ...
        options: {
          ...
          name: 'block.continuity2017.witnesses'
        }
      }, {
        ...
        fields: {
          ...
          'meta.consensus': 1,
          'meta.continuity2017.hasParentHashCommitment': 1,
      ...
      },
      {
        ...
        // for checking if a peer has been committed to
        collection: collections.eventCollection,
        fields: {
          'event.peerCommitment': 1,
          'meta.continuity2017.type': 1,
          'meta.continuity2017.replayDetectedBlockHeight': -1,
          'meta.consensus': 1,
          'meta.continuity2017.creator': 1,
        ...
        options: {
          sparse: false, unique: false, background: false,
          name: 'event.continuity2017.peerCommitment',
          partialFilterExpression: {
            'event.peerCommitment': {$exists: true},
            'meta.continuity2017.type': 'm'
          }
        }
      }]);
